...
public class EqualsDemo {
	public static void main(String[] args) {
		...
		System.out.println("(str1 == str2) 인경우 : " + result1);
		System.out.println("(str1.equals(str2)) 인경우 : " + result2);
		...
		System.out.println("(str3 == str3) 인경우 : " + result3);
		System.out.println("(str4.equals(str4)) 인경우 : " + result4);
		/*
		 * result3 의 결과가 다름으로 나온이유..
		 * - String 클래스의 생성자를 이용하여 String 인스턴스를 생성한 경우에는
		 * - new 연산자에 의해 메모리 할당이 이뤄지기때문에
